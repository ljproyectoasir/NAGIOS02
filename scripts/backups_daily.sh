...
ORIGENES=( /etc/init.d/ /etc/nagios/ /etc/network/interfaces /etc/resolv.conf /var/log/ /root/scripts/ )

# Destinos del backup (array) dentro de /backups/daily/
DESTINOS=( servicios nagios conf-ip resolver logs scripts )
...
DESTINO='/backups/daily/nagios02/'
IPBACKUP1='varys.got'
